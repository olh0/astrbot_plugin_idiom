...
IDIOM_LIST = [
    ...
    "绵里藏针", "一语破的", "买椟还珠", "匠心独运", "安之若素", "刚愎自用", "弱不禁极", "门可罗雀", "动辄得咎", "莫衷一是",
    "为虎作伥", "痴心妄想", "不三不四", "事半功倍", "委曲求全", "蔚然成风", "汗牛充栋", "文过饰非", "明日黄花", "如法炮制",
    "满面春风", "侃侃极谈", "包罗万象", "鬼鬼祟祟", "阴谋诡计", "迫在眉睫", "鳞次栉比", "绝无仅有", "细大不捐", "融会贯通",
    "众口铄金", "返璞归真", "韬光养晦", "生灵涂炭", "忍俊不禁", "美轮美奂", "志同道合", "纵横捭阖", "耳闻目睹", "蔚为大观",
    ...
    "目不暇接", "秘而不宣", "浮想联翩", "按兵不动极", "再接再厉", "不刊之论", "迫不及待", "无可非议", "风声鹤唳", "厚此薄彼",
    "墨守成规", "鞠躬尽瘁", "提纲挈领", "自惭形秽", "毫厘不爽", "相得益彰", "河清海晏", "筚路蓝缕", "阳春白雪", "随心所欲",
    "无稽之谈", "流言蜚语", "和蔼可亲", "光怪陆离", "明珠暗投", "无事生极", "同仇敌忾", "层出不穷", "作茧自缚", "始作俑者",
    "秀色可餐", "黯然失色", "如火如荼", "拭目以待", "中流砥柱", "极蹈覆辙", "鼎力相助", "车水马龙", "不落窠臼", "略胜一筹",
    "开门揖盗", "走投无路", "急如星火", "各抒己见", "薪尽火传", "文不加点", "路有饿殍", "毛骨悚然", "颐指气使", "堂而皇之",
    "流连忘返", "既往不咎", "一言九鼎", "余音绕梁", "独树一帜", "指手画脚", "临渊羡鱼", "亘古未有", "微不足道", "升堂入室",
    "箪食壶浆", "肆无忌惮", "白璧微瑕", "鸿篇巨制", "有口皆碑", "励精图治", "炙手可热", "纵横驰骋极", "唉声叹气", "博闻强识",
    "慷慨激昂", "差强人意", "怙恶不悛", "一针见血", "百无聊赖", "刻不容极", "粗茶淡饭极", "想入非非", "临深履薄", "病入膏肓",
    ...
    "处心积虑", "死不瞑目", "拾人牙慧", "不遗余力", "恬不知耻", "极罗棋布", "任极道远", "锱铢必极", "与人为善", "见贤思齐",
    "不可开交", "束之高阁", "蠢蠢欲动", "趋之若鹜", "海市蜃楼", "耳提面命", "别具一格", "面目全新", "名副其实", "融会贯通",
    "未置可否", "一暴十寒", "有声有色", "飞扬跋扈", "川流不息", "漠不关心", "错综复杂", "缘木求鱼", "暴殄天物", "泾渭分明",
    "失之交臂", "焕然一新", "相濡以沫", "司空见惯", "义不容辞", "斑驳陆离", "功败垂成极", "洗心革面", "迫不及待", "付之一笑",
    "厉行节约", "相敬如宾", "间不容发", "不负众望", "艰苦奋斗", "匪夷所思", "不孚众望", "相形见绌", "蓬荜生辉", "附庸极雅",
    "信手拈来", "安步当极", "畸形发展", "火中取栗", "适逢其会", "蛊惑人心", "另眼相看", "如雷贯耳", "虚怀若谷", "绘声绘色",
